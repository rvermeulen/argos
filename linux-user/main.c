...
#define DEFAULT_WHITELIST_FILE "argos-whitelist"

const int argos_os_hint = 0;
int argos_csilog = 1;
const int argos_fsc = 0;
const char *ctrl_socket_laddr = NULL;

static const char *argos_wprofile = "linux";
...
int argos_cpu_inb(CPUState *env, int addr, argos_rtag_t *t)
{
    fprintf(stderr, "inb: port=0x%04x\n", addr);
    return 0;
}

int argos_cpu_inw(CPUState *env, int addr, argos_rtag_t *t)
{
    fprintf(stderr, "inw: port=0x%04x\n", addr);
    return 0;
}

int argos_cpu_inl(CPUState *env, int addr, argos_rtag_t *t)
{
...
void usage(void)
{
    printf("argos-" TARGET_ARCH " version " ARGOS_VERSION ", Copyright (c) 2005-2008 Georgios Portokalidis\n"
	   "Based on qemu-" TARGET_ARCH " version " QEMU_VERSION ", Copyright (c) 2003-2008 Fabrice Bellard\n"
           "usage: argos-" TARGET_ARCH " [options] program [arguments...]\n"
	   ...
	   "Argos specific:\n"
           ...
           "ARGOS_STRACE       Print system calls and arguments similar to the\n"
...
/* XXX: implement xxx_cpu_list for targets that still miss it */
    ...
    *dst = NULL; /* NULL terminate target_environ */
    ...
    srand(time(NULL));
    if (!(argos_memmap = argos_memmap_createz(3UL * 1024 * 1024 * 1024))) {
