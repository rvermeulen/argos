                          ...
                          int width)
{
    ...
    case 5:
	    ...
	    ARGOS_MEMMAP_CLEAR(pfl->storage, pfl->total_len);
            pfl->status = 0x00;
	    ...
	    ARGOS_MEMMAP_CLEAR(p + offset, pfl->sector_len);
                                ...
                                uint16_t id2, uint16_t id3)
{
	...
	ARGOS_MEMMAP_CLEAR(pfl->storage, total_len >> 9);
    }
