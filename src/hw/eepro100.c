...
static uint32_t ioport_read1(void *opaque, uint32_t addr, argos_rtag_t *tag)
{
...
static uint32_t ioport_read2(void *opaque, uint32_t addr, argos_rtag_t *tag)
{
    EEPRO100State *s = opaque;
    return eepro100_read2(s, addr - s->region[1]);
}

static uint32_t ioport_read4(void *opaque, uint32_t addr, argos_rtag_t *tag)
{
    EEPRO100State *s = opaque;
