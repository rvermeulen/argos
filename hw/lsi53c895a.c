...
static uint32_t lsi_io_readb(void *opaque, uint32_t addr, argos_rtag_t *t)
{
    LSIState *s = (LSIState *)opaque;
    return lsi_reg_readb(s, addr & 0xff);
}

static uint32_t lsi_io_readw(void *opaque, uint32_t addr, argos_rtag_t *t)
{
    LSIState *s = (LSIState *)opaque;
    uint32_t val;
    addr &= 0xff;
...
static uint32_t lsi_io_readl(void *opaque, uint32_t addr, argos_rtag_t *t)
{
    LSIState *s = (LSIState *)opaque;
    uint32_t val;
    addr &= 0xff;
