...
#define EAXTAG (env->regtags + R_EAX)
#define ECXTAG (env->regtags + R_ECX)
#define EDXTAG (env->regtags + R_EDX)
#define EBXTAG (env->regtags + R_EBX)
#define ESPTAG (env->regtags + R_ESP)
#define EBPTAG (env->regtags + R_EBP)
#define ESITAG (env->regtags + R_ESI)
#define EDITAG (env->regtags + R_EDI)
