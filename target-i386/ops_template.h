...
void OPPROTO glue(glue(op_shl, SUFFIX), _T0_T1)(void)
{
    ...
    T0 = T0 << count;
    glue(ARGOS_REG_SHL, SUFFIX)(T0TAG, count);
    FORCE_RET();
}
...
void OPPROTO glue(glue(op_shr, SUFFIX), _T0_T1)(void)
{
    ...
    T0 &= DATA_MASK;
    T0 = T0 >> count;
    glue(ARGOS_REG_SHR, SUFFIX)(T0TAG, count);
    FORCE_RET();
}
...
void OPPROTO glue(glue(op_sar, SUFFIX), _T0_T1)(void)
{
    ...
    src = (DATA_STYPE)T0;
    T0 = src >> count;
    glue(ARGOS_REG_SAR, SUFFIX)(T0TAG, count);
    FORCE_RET();
}
...
void OPPROTO glue(glue(op_bts, SUFFIX), _T0_T1_cc)(void)
{
    ...
    ARGOS_REG_BTS(T0TAG, T1TAG, count);
}
...
void OPPROTO glue(glue(op_btr, SUFFIX), _T0_T1_cc)(void)
{
    ...
    T1 = T0 >> count;
    T0 &= ~(((target_long)1) << count);
    ARGOS_REG_BTR(T0TAG, T1TAG, count);
}
...
void OPPROTO glue(glue(op_in, SUFFIX), _T0_T1)(void)
{
    ...
    T1 = glue(argos_cpu_in, SUFFIX)(env, T0, T1TAG);
}

void OPPROTO glue(glue(op_in, SUFFIX), _DX_T0)(void)
{
    argos_tag_clear(T0TAG);
    T0 = glue(argos_cpu_in, SUFFIX)(env, EDX & 0xffff, T0TAG);
}
