...
static target_ulong disas_insn(DisasContext *s, target_ulong pc_start)
{
 ...
 reswitch:
    ...
    do_shiftd:
        ...
        /* floats */
    case 0xd8 ... 0xdf:
		/* Save the current instruction pointer of the fpu instruction to be executed.*/
		gen_op_argos_save_FPIP_im(pc_start);
        ...
        if (mod != 3) {
            ...
            case 0x0e: /* fnstenv mem */
				/* 
				   Switch fpip to make sure we have the correct one before fldenv saves it.
				   This switch is needed because we save the fpip before we execute the generated op.
				   In our case the fpip points to the ip of this instruction, instead of the last.
				   This instruction updates the state so we have to correct the fpip.
				 */
				gen_op_argos_switch_FPIP();
            ...
            case 0x0a: /* grp d9/2 */
                switch(rm) {
                case 0: /* fnop */
					/* The FNOP instruction does not affect the FPU context, so correct it.*/
					gen_op_argos_switch_FPIP();
